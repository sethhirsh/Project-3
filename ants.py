...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while current_place != None or current_place != hive:
            if min_range > current_distance or max_range < current_distance:
                current_place = current_place.entrance
                current_distance += 1
            elif random_or_none(current_place.bees) == None:
                current_place = current_place.entrance
                current_distance += 1
            else:
